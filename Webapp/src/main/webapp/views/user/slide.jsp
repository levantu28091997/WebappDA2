			...
			<ul class="sequence-canvas">
				<li class="animate-in">
					...
					<div class="flat-image formBottom delay200" data-duration="5"
						data-bottom="true">
						<img
							src="<%=request.getContextPath()%>/resources/home/images/slider-image-01.png"
							alt="">
					</div>
				</li>
				<li>
					...
					<div class="flat-image formBottom delay200" data-bottom="true">
						<img
							src="<%=request.getContextPath()%>/resources/home/images/slider-image-02.png"
							alt="">
					</div>
				</li>
				<li>
					...
					<div class="flat-image formBottom delay200" data-bottom="true">
						<img
							src="<%=request.getContextPath()%>/resources/home/images/slider-image-03.png"
							alt="">
					</div>
				</li>
			</ul>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-4 col-sm-4 col-xs-4">
					<div class="promo-box">
						<img
							src="<%=request.getContextPath()%>/resources/home/images/promotion-01.png"
							alt="">
					</div>
				</div>
				<div class="col-md-4 col-sm-4 col-xs-4">
					<div class="promo-box">
						<img
							src="<%=request.getContextPath()%>/resources/home/images/promotion-02.png"
							alt="">
					</div>
				</div>
				<div class="col-md-4 col-sm-4 col-xs-4">
					<div class="promo-box">
						<img
							src="<%=request.getContextPath()%>/resources/home/images/promotion-03.png"
							alt="">
					</div>
				</div>
			</div>
